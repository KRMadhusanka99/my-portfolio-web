...
const Header = () => {
  ...
  window.addEventListener('scroll', function() {
    // scroll higher than 80 viewport height, add the scroll-header class to the header tag
  ...
  return (
    <header className="header">
      <nav className="nav container">
        <a href="index.html" className="nav__logo">Ramesh Portfolio</a>
        ...
        <div className={Toggle ? "nav__menu show-menu":"nav__menu"}>
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
              <a href="#blogs" onClick={()=>setActiveNav('#blogs')}
              className={activeNav === "#blogs" ? "nav__link active-link":
              "nav__link"}>
            ...
            <li className="nav__item">
              ...
              "nav__link"}>
                <i className="uil uil-message nav__icon"></i>Contatct
              </a>
            </li>
            </ul>
